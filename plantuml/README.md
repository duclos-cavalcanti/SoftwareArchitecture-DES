...
- within the `example` folder, the use of `plantuml`, common `OOP` relationships, `patterns` and even a toy smart app grouping many of these
topics into a single file.
